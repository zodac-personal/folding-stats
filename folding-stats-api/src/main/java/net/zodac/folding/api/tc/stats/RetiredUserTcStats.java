...
/**
 * POJO that extends {@link UserTcStats} adding a retired user ID, team ID and a display name. When a {@link User} is deleted, their stats are stored
 * for the remainder of the {@code Team Competition} period for their team.
 */
