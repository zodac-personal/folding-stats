...
/**
 * Verifies the UI contents of the {@link FrontendLink#USER_HOURLY_URL} page.
 */
class UserHourlyTest {

    private static final int PAGE_INDEX_IN_NAVIGATION_BAR = 2;
    private static final FrontendLink FRONTEND_LINK = FrontendLink.USER_HOURLY_URL;

    @ParameterizedTest
    @EnumSource(BrowserType.class)
    void testLoadUserHourlyPage(final BrowserType browserType) {
