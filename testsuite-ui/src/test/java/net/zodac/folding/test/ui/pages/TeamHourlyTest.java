...
/**
 * Verifies the UI contents of the {@link FrontendLink#TEAM_HOURLY_URL} page.
 */
class TeamHourlyTest {

    private static final int PAGE_INDEX_IN_NAVIGATION_BAR = 3;
    private static final FrontendLink FRONTEND_LINK = FrontendLink.TEAM_HOURLY_URL;

    @ParameterizedTest
    @EnumSource(BrowserType.class)
    void testLoadTeamHourlyPage(final BrowserType browserType) {
