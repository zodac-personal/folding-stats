...
/**
 * Verifies the UI contents of the {@link FrontendLink#USER_MONTHLY_URL} page.
 */
class UserMonthlyTest {

    private static final int PAGE_INDEX_IN_NAVIGATION_BAR = 2;
    private static final FrontendLink FRONTEND_LINK = FrontendLink.USER_MONTHLY_URL;
