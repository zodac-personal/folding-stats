...
public enum FrontendLink {
     ...
     */
    ADMIN_URL("https://frontend-dev:443/admin"),

    /**
     * The URL for the main page of the frontend UI.
     */
    INDEX_URL("https://frontend-dev:443/"),

    /**
     * The URL for the "Request A Change" page of the frontend UI.
     */
    REQUESTS_URL("https://frontend-dev:443/requests"),

    /**
     * The URL for the past results page of the frontend UI.
     */
    RESULTS_URL("https://frontend-dev:443/results"),

    /**
     * The URL for the hourly team page of the frontend UI.
     */
    TEAM_HOURLY_URL("https://frontend-dev:443/historic_team_hourly"),

    /**
     * The URL for the daily team page of the frontend UI.
     */
    TEAM_DAILY_URL("https://frontend-dev:443/historic_team_daily"),

    /**
     * The URL for the monthly team page of the frontend UI.
     */
    TEAM_MONTHLY_URL("https://frontend-dev:443/historic_team_monthly"),

    /**
     * The URL for the hourly user page of the frontend UI.
     */
    USER_HOURLY_URL("https://frontend-dev:443/historic_user_hourly"),

    /**
     * The URL for the daily user page of the frontend UI.
     */
    USER_DAILY_URL("https://frontend-dev:443/historic_user_daily"),

    /**
     * The URL for the monthly user page of the frontend UI.
     */
    USER_MONTHLY_URL("https://frontend-dev:443/historic_user_monthly");
