...
/**
 * Verifies the UI contents of the {@link FrontendLink#USER_DAILY_URL} page.
 */
class UserDailyTest {

    private static final int PAGE_INDEX_IN_NAVIGATION_BAR = 2;
    private static final FrontendLink FRONTEND_LINK = FrontendLink.USER_DAILY_URL;

    @ParameterizedTest
    @EnumSource(BrowserType.class)
    void testLoadUserDailyPage(final BrowserType browserType) {
