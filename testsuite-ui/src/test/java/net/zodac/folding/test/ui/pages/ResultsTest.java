...
/**
 * Verifies the UI contents of the {@link FrontendLink#RESULTS_URL} page.
 */
class ResultsTest {

    private static final int PAGE_INDEX_IN_NAVIGATION_BAR = 1;
    private static final FrontendLink FRONTEND_LINK = FrontendLink.RESULTS_URL;

    @ParameterizedTest
    @EnumSource(BrowserType.class)
    void testLoadResultsPage(final BrowserType browserType) {
