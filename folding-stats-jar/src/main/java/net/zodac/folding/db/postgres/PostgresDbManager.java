...
import static net.zodac.folding.db.postgres.gen.tables.RetiredUserStats.RETIRED_USER_STATS;
import static net.zodac.folding.db.postgres.gen.tables.SystemUsers.SYSTEM_USERS;
import static net.zodac.folding.db.postgres.gen.tables.Teams.TEAMS;
import static net.zodac.folding.db.postgres.gen.tables.UserChanges.USER_CHANGES;
import static net.zodac.folding.db.postgres.gen.tables.UserInitialStats.USER_INITIAL_STATS;
import static net.zodac.folding.db.postgres.gen.tables.UserOffsetTcStats.USER_OFFSET_TC_STATS;
import static net.zodac.folding.db.postgres.gen.tables.UserTcStatsHourly.USER_TC_STATS_HOURLY;
import static net.zodac.folding.db.postgres.gen.tables.UserTotalStats.USER_TOTAL_STATS;
...
import net.zodac.folding.api.util.DateTimeConverterUtils;
