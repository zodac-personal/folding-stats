...
import net.zodac.folding.api.util.CollectionUtils;
...
public final class HardwareSplitter {
    ...
    /**
     * If any of the {@link Hardware} from LARS <b>does</b> already exist in the DB, and the {@code multiplier} or {@code averagePpd} is different,
