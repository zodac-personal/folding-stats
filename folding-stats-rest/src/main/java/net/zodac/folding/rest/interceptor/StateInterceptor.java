...
package net.zodac.folding.rest.interceptor;

import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import java.lang.reflect.Method;
import net.zodac.folding.api.state.OperationType;
import net.zodac.folding.api.state.SystemState;
import net.zodac.folding.rest.exception.ServiceUnavailableException;
...
/**
 * {@link HandlerInterceptor} that intercepts all requests and verifies that the system is in a valid {@link SystemState}
 * to allow {@link OperationType#READ} or {@link OperationType#WRITE} requests.
 *
 * <p>
 * If a function is annotated with {@link ReadRequired} and the current {@link SystemState} does not allow
 * {@link OperationType#READ} operations, or is annotated with {@link WriteRequired} and the current
 * {@link SystemState} does not allow {@link OperationType#WRITE} operations, a
