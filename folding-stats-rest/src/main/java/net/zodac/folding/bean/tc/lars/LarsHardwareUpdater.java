...
package net.zodac.folding.bean.tc.lars;
...
import net.zodac.folding.api.tc.lars.LarsRetriever;
...
import net.zodac.folding.lars.HardwareSplitter;
...
/**
 * Retrieves the latest {@link Hardware} information from LARS for {@link HardwareType}s, then updates
...
public class LarsHardwareUpdater {
    ...
    /**
     * Retrieves {@link HardwareType} data from LARS, creates {@link Hardware} instances, then updates to the DB.
     *
     * <p>
