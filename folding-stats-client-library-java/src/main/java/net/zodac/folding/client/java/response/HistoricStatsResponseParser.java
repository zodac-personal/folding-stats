...
public final class HistoricStatsResponseParser {
     ...
     * {@link HistoricStatsRequestSender#getHourlyUserStats(int, Year, Month, int, String)}.
     *
    ...
    /**
     * Returns the {@link HistoricStats} retrieved by
     * {@link HistoricStatsRequestSender#getDailyUserStats(int, Year, Month, String)}.
     *
     * @param response the {@link HttpResponse} to parse
     * @return the retrieved {@link HistoricStats}
     */
    ...
    /**
     * Returns the {@link HistoricStats} retrieved by
     * {@link HistoricStatsRequestSender#getMonthlyUserStats(int, Year, String)}.
     *
     * @param response the {@link HttpResponse} to parse
     * @return the retrieved {@link HistoricStats}
     */
    ...
    /**
     * Returns the {@link HistoricStats} retrieved by
     * {@link HistoricStatsRequestSender#getHourlyTeamStats(int, Year, Month, int, String)}.
     *
     * @param response the {@link HttpResponse} to parse
     * @return the retrieved {@link HistoricStats}
     */
    ...
    /**
     * Returns the {@link HistoricStats} retrieved by
     * {@link HistoricStatsRequestSender#getDailyTeamStats(int, Year, Month, String)}.
     *
     * @param response the {@link HttpResponse} to parse
     * @return the retrieved {@link HistoricStats}
     */
    ...
    /**
     * Returns the {@link HistoricStats} retrieved by
     * {@link HistoricStatsRequestSender#getMonthlyTeamStats(int, Year, String)}.
     *
     * @param response the {@link HttpResponse} to parse
     * @return the retrieved {@link HistoricStats}
     */
