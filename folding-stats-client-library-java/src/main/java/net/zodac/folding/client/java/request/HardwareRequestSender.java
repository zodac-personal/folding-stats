 ...
 *
 * @param hardwareUrl the URL to the {@link Hardware} REST endpoint
 */
public record HardwareRequestSender(String hardwareUrl) {
     ...
     *
     * <p>
     * <b>NOTE:</b> If the server has a cached {@link Hardware} based on the {@code ETag}, an empty
     * {@link HttpResponse#body()} is returned.
     *
     * @param entityTag the {@code ETag} from a previous {@link HttpResponse}, to retrieve cached {@link Hardware}
     * @return the {@link HttpResponse} from the {@link HttpRequest}
     * @throws FoldingRestException thrown if an error occurs sending the {@link HttpRequest}
     * @see #getAll()
     */
     ...
     *
     * @param hardwareId the ID of the {@link Hardware} to be retrieved
     * @param entityTag  the {@code ETag} from a previous {@link HttpResponse}, to retrieve a cached {@link Hardware}
     * @return the {@link HttpResponse} from the {@link HttpRequest}
     * @throws FoldingRestException thrown if an error occurs sending the {@link HttpRequest}
     * @see #get(int)
     */
