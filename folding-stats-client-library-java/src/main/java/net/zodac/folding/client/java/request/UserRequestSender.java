 ...
 *
 * @param usersUrl the URL to the {@link User} REST endpoint
 */
public record UserRequestSender(String usersUrl) {
    ...
    /**
     * Send a <b>GET</b> request to retrieve all {@link User}s in the system, with passkeys hidden.
     *
     ...
     *
     * <p>
     * <b>NOTE:</b> If the server has a cached {@link User} based on the {@code ETag}, an empty
     * {@link HttpResponse#body()} is returned.
     *
     * @param entityTag the {@code ETag} from a previous {@link HttpResponse}, to retrieve cached {@link User}s
     * @return the {@link HttpResponse} from the {@link HttpRequest}
     * @throws FoldingRestException thrown if an error occurs sending the {@link HttpRequest}
     */
    ...
    /**
     * Send a <b>GET</b> request to retrieve all {@link User}s in the system, with passkeys shown.
     *
     ...
     *
     * @param userId    the ID of the {@link User} to be retrieved
     * @param entityTag the {@code ETag} from a previous {@link HttpResponse}, to retrieve a cached {@link User}
     * @return the {@link HttpResponse} from the {@link HttpRequest}
     * @throws FoldingRestException thrown if an error occurs sending the {@link HttpRequest}
     * @see #get(int)
     */
    ...
    /**
     * Send a <b>GET</b> request to retrieve a single {@link User} with passkey with the given {@code userId}.
     *
     * @param userId   the ID of the {@link User} to be retrieved
     * @param userName the username
     * @param password the password
