 ...
 *
 * @param teamsUrl the URL to the {@link Team} REST endpoint
 */
public record TeamRequestSender(String teamsUrl) {
     ...
     *
     * <p>
     * <b>NOTE:</b> If the server has a cached {@link Team} based on the {@code ETag}, an empty
     * {@link HttpResponse#body()} is returned.
     *
     * @param entityTag the {@code ETag} from a previous {@link HttpResponse}, to retrieve cached {@link Team}s
     * @return the {@link HttpResponse} from the {@link HttpRequest}
     * @throws FoldingRestException thrown if an error occurs sending the {@link HttpRequest}
     * @see #getAll()
     */
     ...
     *
     * @param teamId    the ID of the {@link Team} to be retrieved
     * @param entityTag the {@code ETag} from a previous {@link HttpResponse}, to retrieve a cached {@link Team}
     * @return the {@link HttpResponse} from the {@link HttpRequest}
     * @throws FoldingRestException thrown if an error occurs sending the {@link HttpRequest}
     * @see #get(int)
     */
    ...
    /**
     * Send a <b>GET</b> request to retrieve a single {@link Team} with the given {@code teamName}.
     *
     * @param teamName the {@code teamName} of the {@link Team} to be retrieved
     * @return the {@link HttpResponse} from the {@link HttpRequest}
     * @throws FoldingRestException thrown if an error occurs sending the {@link HttpRequest}
     ...
     *
     * @param teamId   the ID of the {@link Team} to update
