...
import static net.zodac.folding.test.integration.util.DummyDataGenerator.generateTeamWithName;
import static net.zodac.folding.test.integration.util.DummyDataGenerator.nextTeamName;
import static net.zodac.folding.test.integration.util.SystemCleaner.cleanSystemForSimpleTests;
...
import static net.zodac.folding.test.integration.util.rest.request.TeamUtils.create;
import static net.zodac.folding.test.integration.util.rest.response.HttpResponseHeaderUtils.getEntityTag;
import static net.zodac.folding.test.integration.util.rest.response.HttpResponseHeaderUtils.getTotalCount;
