...
import static net.zodac.folding.test.integration.util.TestConstants.INVALID_FORMAT_ID;
...
import net.zodac.folding.client.java.request.HistoricStatsType;
import net.zodac.folding.client.java.request.RestUri;
import net.zodac.folding.client.java.response.HistoricStatsResponseParser;
...
import net.zodac.folding.test.integration.util.DummyStats;
...
class HistoricTeamStatsTest {
    ...
    void whenGettingHourlyStats_andValidTeamIdIsGiven_andAllUsersHaveNoStats_thenNoStatsAreReturned_andResponseHas200Status()
        ...
        UserUtils.create(DummyDataGenerator.generateUserWithTeamId(team.id()));
    ...
    void whenGettingHourlyStats_andValidTeamIdIsGiven_andUserHasSomeStats_thenStatsAreReturned_andResponseHas200Status() throws FoldingRestException {
        final Team team = TeamUtils.create(DummyDataGenerator.generateTeam());
        final int userId = UserUtils.create(DummyDataGenerator.generateUserWithTeamId(team.id())).id();
    ...
    void whenGettingHourlyStats_andTeamHasMultipleUsersInSameHour_thenCombinedStatsForAllUsersAreReturned_andResponseHas200Status()
        throws FoldingRestException {
        final Team team = TeamUtils.create(DummyDataGenerator.generateTeam());
        final int firstUserId = UserUtils.create(DummyDataGenerator.generateUserWithTeamIdAndCategory(team.id(), Category.AMD_GPU)).id();
        final int secondUserId = UserUtils.create(DummyDataGenerator.generateUserWithTeamIdAndCategory(team.id(), Category.NVIDIA_GPU)).id();
        DatabaseUtils.insertStats("user_tc_stats_hourly",
            DummyStats.create(firstUserId, "2020-04-11 23:00:00", 0L, 0L, 0),
            DummyStats.create(secondUserId, "2020-04-11 23:00:00", 0L, 0L, 0),
            DummyStats.create(firstUserId, "2020-04-12 13:00:00", 50L, 500L, 5),
            DummyStats.create(secondUserId, "2020-04-12 13:00:00", 50L, 500L, 5),
            DummyStats.create(firstUserId, "2020-04-12 14:00:00", 100L, 1_000L, 10),
            DummyStats.create(firstUserId, "2020-04-12 14:30:00", 110L, 1_100L, 11),
            DummyStats.create(secondUserId, "2020-04-12 14:30:00", 200L, 2_000L, 20)
        );
    ...
    void whenGettingDailyStats_andTeamHasMultipleUsersInSameDay_thenCombinedStatsForAllUsersAreReturned_andResponseHas200Status()
        ...
        DatabaseUtils.insertStats("user_tc_stats_hourly",
            DummyStats.create(firstUserId, "2020-04-12 13:00:00", 50L, 500L, 5),
            DummyStats.create(secondUserId, "2020-04-12 13:00:00", 50L, 500L, 5),
            DummyStats.create(firstUserId, "2020-04-13 14:00:00", 100L, 1_000L, 10),
            DummyStats.create(firstUserId, "2020-04-13 14:30:00", 110L, 1_100L, 11),
            DummyStats.create(secondUserId, "2020-04-13 14:30:00", 200L, 2_000L, 20)
        );
    ...
    void whenGettingMonthlyStats_andTeamHasMultipleUsersInSameMonth_thenCombinedStatsForAllUsersAreReturned_andResponseHas200Status()
        ...
        final int secondUserId = UserUtils.create(DummyDataGenerator.generateUserWithTeamIdAndCategory(team.id(), Category.NVIDIA_GPU)).id();
        DatabaseUtils.insertStats("user_tc_stats_hourly",
            DummyStats.create(firstUserId, "2020-03-12 13:00:00", 50L, 500L, 5), // No diff from this result, since stats are reset each month
            DummyStats.create(secondUserId, "2020-03-12 13:00:00", 50L, 500L, 5),
            DummyStats.create(firstUserId, "2020-04-13 14:00:00", 100L, 1_000L, 10),
            DummyStats.create(firstUserId, "2020-04-13 14:30:00", 110L, 1_100L, 11),
            DummyStats.create(secondUserId, "2020-04-13 14:30:00", 200L, 2_000L, 20)
        );
