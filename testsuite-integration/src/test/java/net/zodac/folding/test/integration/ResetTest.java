...
import static net.zodac.folding.test.integration.util.DummyDataGenerator.generateCaptainWithTeamIdAndCategory;
import static net.zodac.folding.test.integration.util.DummyDataGenerator.generateHardwareFromCategory;
...
import static net.zodac.folding.test.integration.util.DummyDataGenerator.nextUserName;
...
import static net.zodac.folding.test.integration.util.rest.request.TeamCompetitionStatsUtils.manuallyResetStats;
...
import static net.zodac.folding.test.integration.util.rest.request.UserUtils.create;
